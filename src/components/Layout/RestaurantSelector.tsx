    ...
    >
      <div className="bg-white rounded-t-2xl sm:rounded-2xl w-full max-w-md max-h-[80vh] overflow-hidden animate-slide-up">
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900">Выберите ресторан</h2>
          <button
            onClick={onClose}
        ...
        <div className="overflow-y-auto max-h-96">
          {filteredRestaurants.length === 0 ? (
            <div className="p-8 text-center text-gray-500">
              {searchQuery ? 'Рестораны не найдены' : 'Нет ресторанов'}
            </div>
          ) : (
            <div className="p-2">
                ...
                >
                  ...
                  <div className="flex-1 min-w-0 text-left">
                    ...
                    <p className="text-xs text-gray-500 truncate">
                      {restaurant.description || 'Без описания'}
                    </p>
                  </div>
                  {selectedRestaurant?.id === restaurant.id && (
        ...
        <div className="p-4 border-t border-gray-200">
          ...
          >
            ...
            <span>Создать новый ресторан</span>
          </button>
        </div>
      </div>
    </div>
